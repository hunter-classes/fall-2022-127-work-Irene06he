# I finish extras 1 - write a story in a file and
# read it from your program, and
# extras 2--><HERO> would randomly choose a hero once
# and then use that name for all instances of <HERO>

import random

f = open('story.py')# I received assistance from Kai Min
story = f.read()
f.close()
